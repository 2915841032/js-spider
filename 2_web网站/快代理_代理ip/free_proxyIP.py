...
def validate(ip):
    ...
    print(IP)
    try:
        r = requests.get('https://baidu.shanshanku.com/20230825/En7hVJ74/1200kb/hls/jdCkNjAW.ts', proxies=IP,
...
def main():
    csv_file = open('IP/今日影视.csv', 'w', newline='')
    writer = csv.writer(csv_file)
    writer.writerow(['ip'])
    url = 'https://www.kuaidaili.com/free/inha/{}/'  # 这是网站的 url
    for i in range(1, 6):  # 爬取四十页
        time.sleep(1)  # 休息 1 秒
