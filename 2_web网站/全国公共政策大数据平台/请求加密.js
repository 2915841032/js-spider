...
// r={}
// r["data"] = PolicyInfoByTypeIdParam$encode(r["data"])["finish"]()["slice"]()
// m={
//     "policyType": "4",
//     "province": "",
//     "city": "",
...
//     "pageSize": 7
// }
// r["data"] = PolicyInfoByTypeIdParam$encode(m)["finish"]()["slice"]()
// console.log(r["data"])


function ank(m){
    // var text = PolicyInfoByTypeIdParam$encode(m)["finish"]()["slice"]()
    var text = PolicyInfoByTypeIdParam$encode(m)["finish"]()["slice"]().toString("base64")
    return text
}